...
public class GraphPointsQubicImSlopeXGenerator extends IGraphPointsGenerator
{
    private GraphInfosIterator mIterator = new GraphInfosIterator();
    private QubicEquationSolver mSolver;
    ...
    public GraphPointsQubicImSlopeXGenerator( float a, float b, float c, float d )
    {
    	mSolver = new QubicEquationSolver( a, b, c, d );
    }
