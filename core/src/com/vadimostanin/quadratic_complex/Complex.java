...
public final class Complex {
    ...
    public void set(double real_part)
    {
    	x = real_part;
    }
    
    public void set(double real_part, double imaginary_part)
    {
    	x = real_part;
    	y = imaginary_part;
    }
    ...
    public Complex add( Complex z, Complex result ) {
    	result.set( x + z.x, y + z.y );
        return result;
    }
    
    public Complex add( float re, float im, Complex result ) {
    	result.set( x + re, y + im );
        return result;
    }
    ...
    public Complex mult(Complex z, Complex result) {
    	result.set( x * z.x - y * z.y, x * z.y + z.x * y );
        return result;
    }
    
    public Complex mult( float multiplier ) {
    	return new Complex( multiplier * x, multiplier * y );
    }
    
    public Complex mult( float multiplier, Complex result ) {
    	result.set( x * multiplier, y * multiplier );
        return result;
    }
